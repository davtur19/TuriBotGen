...
abstract class Api implements ApiInterface {
    ...
    public function setWebhook(
        string $url,
        \CURLFile|null $certificate = null,
    ...
    public function sendMessage(
        ...
        string|null $callback_query_id = null,
        ...
        if (null !== $receiver_user_id) $args['receiver_user_id'] = $receiver_user_id;
        if (null !== $callback_query_id) $args['callback_query_id'] = $callback_query_id;
    ...
    public function forwardMessage(
        ...
        int|null $message_thread_id = null,
        int|null $direct_messages_topic_id = null,
        int|null $video_start_timestamp = null,
        bool|null $disable_notification = null,
        bool|null $protect_content = null,
        string|null $message_effect_id = null,
        array|null $suggested_post_parameters = null
     ...
     * only if the value of the field correct_option_ids is known to the bot. The method is analogous to
    ...
    public function copyMessage(
        ...
        string|null $parse_mode = null,
        array|null $caption_entities = null,
        bool|null $show_caption_above_media = null,
        bool|null $disable_notification = null,
        bool|null $protect_content = null,
        bool|null $allow_paid_broadcast = null,
        string|null $message_effect_id = null,
     ...
     * field correct_option_ids is known to the bot. The method is analogous to the method forwardMessages,
     ...
     * @param \CURLFile|string|InputFile $photo The static photo to send. Pass a file_id as String to send a photo that exists on the Telegram
    ...
    public function sendLivePhoto(
        int|string $chat_id,
        \CURLFile|string|InputFile $live_photo,
        \CURLFile|string|InputFile $photo,
        int|null $message_thread_id = null,
        int|null $direct_messages_topic_id = null,
        int|null $receiver_user_id = null,
        ...
        return $this->Request('sendLivePhoto', $args);
    }
    ...
    public function sendAudio(
        ...
        \CURLFile|string|InputFile|null $thumbnail = null,
        bool|null $disable_notification = null,
        bool|null $protect_content = null,
        bool|null $allow_paid_broadcast = null,
        string|null $message_effect_id = null,
    ...
    public function sendDocument(
        ...
        string|null $parse_mode = null,
        array|null $caption_entities = null,
        bool|null $disable_content_type_detection = null,
        bool|null $disable_notification = null,
        bool|null $protect_content = null,
        bool|null $allow_paid_broadcast = null,
        string|null $message_effect_id = null,
    ...
    public function sendVideo(
        ...
        \CURLFile|string|InputFile|null $thumbnail = null,
        \CURLFile|string|InputFile|null $cover = null,
        int|null $start_timestamp = null,
        string|null $caption = null,
        string|null $parse_mode = null,
        array|null $caption_entities = null,
        bool|null $show_caption_above_media = null,
        bool|null $has_spoiler = null,
        bool|null $supports_streaming = null,
        bool|null $disable_notification = null,
        bool|null $protect_content = null,
        bool|null $allow_paid_broadcast = null,
        string|null $message_effect_id = null,
     ...
     * @param int|null $live_period Period in seconds during which the location will be updated (see Live Locations), must be between 60
     *                                       and 86400, or 0x7FFFFFFF for live locations that can be edited indefinitely. Must be 0 for ephemeral
     *                                       messages.
    ...
    public function sendLocation(
        ...
        int|null $receiver_user_id = null,
        string|null $callback_query_id = null,
        float|null $horizontal_accuracy = null,
        int|null $live_period = null,
        int|null $heading = null,
        int|null $proximity_alert_radius = null,
        bool|null $disable_notification = null,
        bool|null $protect_content = null,
        bool|null $allow_paid_broadcast = null,
        string|null $message_effect_id = null,
    ...
    public function sendVenue(
        ...
        int|null $receiver_user_id = null,
        string|null $callback_query_id = null,
        string|null $foursquare_id = null,
        string|null $foursquare_type = null,
        string|null $google_place_id = null,
        string|null $google_place_type = null,
        bool|null $disable_notification = null,
        bool|null $protect_content = null,
        bool|null $allow_paid_broadcast = null,
        string|null $message_effect_id = null,
     ...
     * @param array|null $media Media added to the poll description
     * @param bool|null $disable_notification Sends the message silently. Users will receive a notification with no sound.
     * @param bool|null $protect_content Protects the contents of the sent message from forwarding and saving
     * @param bool|null $allow_paid_broadcast Pass True to allow up to 1000 messages per second, ignoring broadcasting limits for a fee of 0.1
     *                                       Telegram Stars per message. The relevant Stars will be withdrawn from the bot's balance.
    ...
    public function sendPoll(
        ...
        array $options,
        int|null $message_thread_id = null,
        string|null $question_parse_mode = null,
        array|null $question_entities = null,
        ...
        bool|null $members_only = null,
        array|null $country_codes = null,
        ...
        array|null $explanation_media = null,
        ...
        if (null !== $members_only) $args['members_only'] = $members_only;
        if (null !== $country_codes) $args['country_codes'] = json_encode($country_codes);
        ...
        if (null !== $explanation_media) $args['explanation_media'] = json_encode($explanation_media);
        ...
        if (null !== $media) $args['media'] = json_encode($media);
        if (null !== $disable_notification) $args['disable_notification'] = $disable_notification;
        if (null !== $protect_content) $args['protect_content'] = $protect_content;
        if (null !== $allow_paid_broadcast) $args['allow_paid_broadcast'] = $allow_paid_broadcast;
        if (null !== $message_effect_id) $args['message_effect_id'] = $message_effect_id;
    ...
    public function sendMessageDraft(
        ...
        return $this->Request('sendMessageDraft', $args);
    }
    ...
    public function setUserEmojiStatus(
        int $user_id,
        string|null $emoji_status_custom_emoji_id = null,
        int|null $emoji_status_expiration_date = null
    ): \stdClass {
        $args = [
            'user_id' => $user_id
        ];
    ...
    public function banChatMember(
        int|string $chat_id,
        int $user_id,
        int|null $until_date = null,
        bool|null $revoke_messages = null
    ): \stdClass {
        $args = [
            'chat_id' => $chat_id,
            'user_id' => $user_id
    ...
    public function restrictChatMember(
        ...
        int $user_id,
        array $permissions,
        bool|null $use_independent_chat_permissions = null,
        int|null $until_date = null
    ): \stdClass {
        $args = [
            'chat_id' => $chat_id,
    ...
    public function promoteChatMember(
        ...
        int $user_id,
        bool|null $is_anonymous = null,
        bool|null $can_manage_chat = null,
        bool|null $can_delete_messages = null,
        bool|null $can_manage_video_chats = null,
        bool|null $can_restrict_members = null,
        bool|null $can_promote_members = null,
        bool|null $can_change_info = null,
        bool|null $can_invite_users = null,
        bool|null $can_post_stories = null,
        bool|null $can_edit_stories = null,
        bool|null $can_delete_stories = null,
        bool|null $can_post_messages = null,
    ...
    public function createChatInviteLink(
        ...
        int|null $expire_date = null,
        int|null $member_limit = null,
        bool|null $creates_join_request = null
    ): \stdClass {
        $args = [
            'chat_id' => $chat_id
        ];
    ...
    public function getChatAdministrators(
        int|string $chat_id,
        bool|null $return_bots = null
    ): \stdClass {
        $args = [
            'chat_id' => $chat_id
        ];

        if (null !== $return_bots) $args['return_bots'] = $return_bots;
    ...
    public function getUserPersonalChatMessages(
        ...
        return $this->Request('getUserPersonalChatMessages', $args);
    }
    ...
    public function createForumTopic(
        int|string $chat_id,
        string $name,
        int|null $icon_color = null,
        string|null $icon_custom_emoji_id = null
    ): \stdClass {
        $args = [
            'chat_id' => $chat_id,
            'name' => $name
     ...
     * chat for this to work and must have the can_delete_messages administrator rights. Returns True on
     * success.
     *
     * @param int|string $chat_id Unique identifier for the target chat or username of the target supergroup in the format @username
     * @param int $message_thread_id Unique identifier for the target message thread of the forum topic
    ...
    public function answerCallbackQuery(
        ...
        string|null $text = null,
        bool|null $show_alert = null,
        string|null $url = null,
        int|null $cache_time = null
    ): \stdClass {
        $args = [
    ...
    public function answerGuestQuery(
        ...
        return $this->Request('answerGuestQuery', $args);
    }
    ...
    public function getManagedBotAccessSettings(
        ...
        return $this->Request('getManagedBotAccessSettings', $args);
    }
     ...
     * @param array|null $added_user_ids A JSON-serialized list of up to 10 identifiers of users who will have access to the bot in addition
    ...
    public function setManagedBotAccessSettings(
        ...
        array|null $added_user_ids = null
    ): \stdClass {
        $args = [
            'user_id' => $user_id,
        ...
        if (null !== $added_user_ids) $args['added_user_ids'] = json_encode($added_user_ids);

        return $this->Request('setManagedBotAccessSettings', $args);
    }
    ...
    public function setMyDefaultAdministratorRights(
        array|null $rights = null,
        bool|null $for_channels = null
    ): \stdClass {
        $args = [];
    ...
    public function sendGift(
        ...
        bool|null $pay_for_upgrade = null,
        string|null $text = null,
        string|null $text_parse_mode = null,
        array|null $text_entities = null
    ): \stdClass {
        $args = [
            'gift_id' => $gift_id
        ];
    ...
    public function verifyUser(
        int $user_id,
        string|null $custom_description = null
    ): \stdClass {
        $args = [
            'user_id' => $user_id
        ];
     ...
     *
     * @param int|string $chat_id Unique identifier for the target chat or username of the target bot or channel in the format
     *                                       @username
     * @return \stdClass
     *
     ...
     *
     * @param bool $show_gift_button Pass True if a button for sending a gift to the user or by the business account must always be shown
     *                                       in the input field
     ...
     * @param bool|null $exclude_limited_upgradable Pass True to exclude gifts that can be purchased a limited number of times and can be upgraded to
     *                                       unique
     * @param bool|null $exclude_limited_non_upgradable Pass True to exclude gifts that can be purchased a limited number of times and can't be upgraded to
     *                                       unique
    ...
    public function getBusinessAccountGifts(
        string $business_connection_id,
        bool|null $exclude_unsaved = null,
        bool|null $exclude_saved = null,
        bool|null $exclude_unlimited = null,
        bool|null $exclude_limited_upgradable = null,
        bool|null $exclude_limited_non_upgradable = null,
        bool|null $exclude_unique = null,
        bool|null $exclude_from_blockchain = null,
        bool|null $sort_by_price = null,
        ...
        if (null !== $exclude_limited_upgradable) $args['exclude_limited_upgradable'] = $exclude_limited_upgradable;
        if (null !== $exclude_limited_non_upgradable) $args['exclude_limited_non_upgradable'] = $exclude_limited_non_upgradable;
        if (null !== $exclude_unique) $args['exclude_unique'] = $exclude_unique;
        if (null !== $exclude_from_blockchain) $args['exclude_from_blockchain'] = $exclude_from_blockchain;
    ...
    public function getUserGifts(
        ...
        return $this->Request('getUserGifts', $args);
    }
    ...
    public function getChatGifts(
        ...
        return $this->Request('getChatGifts', $args);
    }
    ...
    public function upgradeGift(
        string $owned_gift_id,
        string $business_connection_id,
        bool|null $keep_original_details = null,
        int|null $star_count = null
    ): \stdClass {
        $args = [
            'owned_gift_id' => $owned_gift_id,
            'business_connection_id' => $business_connection_id
    ...
    public function postStory(
        ...
        bool|null $post_to_chat_page = null,
        bool|null $protect_content = null
    ): \stdClass {
        $args = [
    ...
    public function repostStory(
        ...
        return $this->Request('repostStory', $args);
    }
     ...
     *                                       instead of parse_mode
     * @param array|null $link_preview_options Link preview generation options for the message
     * @param array|null $rich_message New rich content of the message; required if text isn't specified. Direct upload of new files isn't
    ...
    public function editEphemeralMessageText(
        ...
        return $this->Request('editEphemeralMessageText', $args);
    }

    /**
     * Use this method to edit the media of an ephemeral message. Note that it is not guaranteed that the
     * user will receive the message edit event, especially if they are offline. On success, True is
     * returned.
     *
     * @param int|string $chat_id Unique identifier for the target chat or username of the target supergroup in the format @username
     * @param int $receiver_user_id Identifier of the user who received the message
     * @param int $ephemeral_message_id Identifier of the ephemeral message to edit
     * @param array $media A JSON-serialized object for the new media content of the message. A new file can't be uploaded; use
     *                                       a previously uploaded file via its file_id or specify a URL.
     * @param array|null $reply_markup A JSON-serialized object for an inline keyboard
     * @return \stdClass
     *
    ...
    public function editEphemeralMessageMedia(
        ...
        return $this->Request('editEphemeralMessageMedia', $args);
    }
    ...
    public function editEphemeralMessageCaption(
        ...
        return $this->Request('editEphemeralMessageCaption', $args);
    }
    ...
    public function editEphemeralMessageReplyMarkup(
        ...
        return $this->Request('editEphemeralMessageReplyMarkup', $args);
    }
    ...
    public function approveSuggestedPost(
        ...
        if (null !== $send_date) $args['send_date'] = $send_date;

        return $this->Request('approveSuggestedPost', $args);
    }
    ...
    public function declineSuggestedPost(
        ...
        if (null !== $comment) $args['comment'] = $comment;

        return $this->Request('declineSuggestedPost', $args);
    }
    ...
    public function deleteEphemeralMessage(
        ...
        return $this->Request('deleteEphemeralMessage', $args);
    }
    ...
    public function deleteMessageReaction(
        ...
        if (null !== $user_id) $args['user_id'] = $user_id;
        if (null !== $actor_chat_id) $args['actor_chat_id'] = $actor_chat_id;

        return $this->Request('deleteMessageReaction', $args);
    }
    ...
    public function deleteAllMessageReactions(
        ...
        return $this->Request('deleteAllMessageReactions', $args);
    }
    ...
    public function createNewStickerSet(
        ...
        string $title,
        array $stickers,
        string|null $sticker_type = null,
        bool|null $needs_repainting = null
    ): \stdClass {
        $args = [
            'user_id' => $user_id,
            'name' => $name,
    ...
    public function setCustomEmojiStickerSetThumbnail(
        string $name,
        string|null $custom_emoji_id = null
    ): \stdClass {
        $args = [
            'name' => $name
        ];
     ...
     * @param int $draft_id Unique identifier of the message draft; must be non-zero. Changes to drafts with the same identifier
     *                                       are animated.
     * @param array $rich_message The partial message to be streamed. Direct upload of new files isn't supported.
     * @return \stdClass
     *
    ...
    public function answerInlineQuery(
        ...
        array $results,
        int|null $cache_time = null,
        bool|null $is_personal = null,
        string|null $next_offset = null,
        array|null $button = null
    ): \stdClass {
        $args = [
    ...
    public function sendInvoice(
        ...
        int|null $message_thread_id = null,
        int|null $direct_messages_topic_id = null,
        string|null $provider_token = null,
        int|null $max_tip_amount = null,
        array|null $suggested_tip_amounts = null,
        string|null $start_parameter = null,
        string|null $provider_data = null,
        string|null $photo_url = null,
        int|null $photo_size = null,
        int|null $photo_width = null,
        int|null $photo_height = null,
        bool|null $need_name = null,
        bool|null $need_phone_number = null,
        bool|null $need_email = null,
        bool|null $need_shipping_address = null,
        bool|null $send_phone_number_to_provider = null,
        bool|null $send_email_to_provider = null,
        bool|null $is_flexible = null,
        bool|null $disable_notification = null,
        bool|null $protect_content = null,
        bool|null $allow_paid_broadcast = null,
        string|null $message_effect_id = null,
    ...
    public function createInvoiceLink(
        ...
        array $prices,
        string|null $provider_token = null,
        int|null $subscription_period = null,
        int|null $max_tip_amount = null,
        array|null $suggested_tip_amounts = null,
        string|null $provider_data = null,
        string|null $photo_url = null,
    ...
    public function answerShippingQuery(
        ...
        bool $ok,
        array|null $shipping_options = null,
    ...
    public function setGameScore(
        ...
        bool|null $disable_edit_message = null,
        int|null $chat_id = null,
        int|null $message_id = null,
        string|null $inline_message_id = null
    ): \stdClass {
